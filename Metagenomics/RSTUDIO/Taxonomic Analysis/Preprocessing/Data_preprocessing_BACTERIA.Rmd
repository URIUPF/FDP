...
kraken_reports_dir <- "/home/uriii/Desktop/BIOINFORMATICS/INT_FDG/ANALYSIS/DATA/Metagenomics/KRAKEN/BACTERIA/Reports (copy)/"
...
report_files <- list.files(kraken_reports_dir, pattern = "\\.report_B$", full.names = TRUE)
...
```{r}
write.csv(combined_metadata, "metadata_BACTERIA.csv", row.names = FALSE)
write.csv(reports_df, "report_data_BACTERIA.csv", row.names = FALSE)
write.csv(merged_data, "DATA_BACTERIA.csv", row.names = FALSE)
```