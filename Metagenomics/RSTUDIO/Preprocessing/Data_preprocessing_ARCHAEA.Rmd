...
kraken_reports_dir <- "/home/uriii/Desktop/BIOINFORMATICS/INT_FDG/ANALYSIS/DATA/Metagenomics/KRAKEN/ARCHAEA/Reports"
...
report_files <- list.files(kraken_reports_dir, pattern = "\\.report_A$", full.names = TRUE)
...
```{r}
write.csv(combined_metadata, "/home/uriii/Desktop/BIOINFORMATICS/INT_FDG/ANALYSIS/DATA/Metagenomics/KRAKEN/ARCHAEA/metadata_ARCHAEA.csv", row.names = FALSE)
write.csv(reports_df, "/home/uriii/Desktop/BIOINFORMATICS/INT_FDG/ANALYSIS/DATA/Metagenomics/KRAKEN/ARCHAEA/report_data_ARCHAEA.csv", row.names = FALSE)
write.csv(merged_data, "/home/uriii/Desktop/BIOINFORMATICS/INT_FDG/ANALYSIS/DATA/Metagenomics/KRAKEN/ARCHAEA/DATA_ARCHAEA.csv", row.names = FALSE)
```
