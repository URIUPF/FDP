...
kraken_reports_dir <- "/home/uriii/Desktop/BIOINFORMATICS/INT_FDG/ANALYSIS/DATA/Metagenomics/KRAKEN/PROTOZOA/careful-assembly"
...
report_files <- list.files(kraken_reports_dir, pattern = "\\.report_P$", full.names = TRUE)
...
```{r}
write.csv(combined_metadata, "/home/uriii/Desktop/BIOINFORMATICS/INT_FDG/ANALYSIS/DATA/Metagenomics/KRAKEN/PROTOZOA/metadata_PROTOZOA.csv", row.names = FALSE)
write.csv(reports_df, "/home/uriii/Desktop/BIOINFORMATICS/INT_FDG/ANALYSIS/DATA/Metagenomics/KRAKEN/PROTOZOA/report_data_PROTOZOA.csv", row.names = FALSE)
write.csv(merged_data, "/home/uriii/Desktop/BIOINFORMATICS/INT_FDG/ANALYSIS/DATA/Metagenomics/KRAKEN/PROTOZOA/DATA_PROTOZOA.csv", row.names = FALSE)
```
